...
/*     yearLabel.call(d3.drag()
    ...
    node
        ...
        .attr('x',d => -30 * 0.7)
        .attr('y',d => -30 * 0.7)
        .attr('height',d => 30 * 2 * 0.7)
        .attr('width',d =>  30 * 2 * 0.7);
        //d.radiusをどう入れるか.
/*         .attr('x',d => - d.r * 0.7)
        .attr('y',d => - d.r * 0.7)
    ...
    simulation
        ...
        .force('collide', 
            d3.forceCollide()
                .radius(
                    function(d) 
                    {return get_radius(d,Math.floor(current_index))  + padding }
                )
                .strength(0.7)
        )
...
/*         circles
    ...
    function dragged_axis(event,d) {
        ...
        svg.selectAll(".node_circle")
            .data(nodesData,function(d) {return d.code}).call(set_radius,Math.floor(current_index))
/*         simulation
            .nodes(nodesData)
            .on("tick", ticked); */
        drag_delta = 0;
